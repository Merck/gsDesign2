...
## Test 3: fixed design with 3 equal info
x1_a <- gs_design_npe(
  theta = c(.1, .2, .3),
...
## Test 4: fixed design with 3 unequal info
x1_a <- gs_design_npe(
  theta = c(.1, .2, .3),
...
## Test 5: futility at IA1; efficacy only at IA2 +FA
...
## Test 7: 2-sided symmetric spend
x1_a <- gs_design_npe(
  theta = c(.1, .2, .3),
