# check that integer is returned when
# check total event count vs gsDesign::eEvents
testthat::test_that("expected events is different from gsDesign::eEvents and eEvents_df",{
  ...
  totalDuration <- 20
  testthat::expect_equivalent(gsDesign2::eEvents_df(enrollRates,failRates,totalDuration,simple=TRUE),
