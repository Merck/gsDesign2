...
# Test 4: Specified information fraction
...
# Test 5: Multiple analysis times & IF and driven by times.
...
# Test 6: Multiple analysis times & IF and driven by IF.
...
# Test 7: 2-sided symmetric design with O'Brien-Fleming spending
x1 <- gs_design_ahr(
...
# Test 8: Pocock lower spending under H1 (NPH).
x1 <- gs_design_ahr(
  analysis_time = c(12, 24, 36), binding = TRUE,
  upper = gs_spending_bound,
  upar = list(sf = gsDesign::sfLDOF, total_spend = 0.025, param = NULL, timing = NULL),
