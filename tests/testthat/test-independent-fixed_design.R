...
test_that("input checking", {
  ...
  expect_error(fixed_design("fh", alpha = 0.025, power = 0.9, enroll_rate = enroll_rate, fail_rate = fail_rate, 
                            study_duration = study_duration, ratio = ratio, rho = c(0.5, 0)))
  expect_error(fixed_design("mb", alpha = 0.025, power = 0.9, enroll_rate = enroll_rate, fail_rate = fail_rate, 
                            study_duration = study_duration, ratio = ratio, rho = c(0.5, 0)))
