...
assert("Validate calendar-time and info-frac driven design -- A",{
  ...
  (x$analysis$time[idx_driven_by_time] %==% analysis_time[idx_driven_by_time])
  (x$analysis$info_frac[idx_driven_by_info_frac] %==% info_frac[idx_driven_by_info_frac])
})
