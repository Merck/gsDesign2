...
eEvents_df(enroll_rate = enroll_rate, fail_rate = fail_rate, total_duration = total_duration, simple = FALSE)
```
...
try(eEvents_df(enroll_rate = enroll_rate, fail_rate = fail_rate, total_duration = total_duration, simple = FALSE))
```
