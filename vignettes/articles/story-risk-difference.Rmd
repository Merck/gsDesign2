...
# under info_scale = "h0-h1-info"
y_2 <- gs_design_npe(
  theta = .4 - .28,
  info = x$info1,
  info0 = x$info0,
  info_scale = "h0-h1-info",
  alpha = .025,
  beta = .1,
  upper = gs_b,
  lower = gs_b,
...
tibble(
  `info_scale = "h0-info"` = y_0$info0[1] / x$info0[1],
  `info_scale = "h1-info"` = y_1$info1[1] / x$info1[1],
  `info_scale = "h0-h1-info"` = y_2$info[1] / x$info1[1]
) %>%
  gt::gt() %>%
...
tibble::tibble(
  ...
  cols_label(
    gsDesign2_info_scale_0 = "info_scale = `h0-info`",
    gsDesign2_info_scale_1 = "info_scale = `h1-info`",
    gsDesign2_info_scale_2 = "info_scale = `h0-h1-info`",
...
tibble(
  `info_scale = "h0-info"` = y_gs0$info0 / x_gs$info0[3],
  `info_scale = "h1-info"` = y_gs1$info1 / x_gs$info1[3],
  `info_scale = "h0-h1-info"` = y_gs2$info / x_gs$info1[3]
) %>%
  gt::gt() %>%
  gt::tab_header(
...
ans %>%
  ...
  cols_label(
    INVAR0 = "info_scale = `h0-info`",
    INVAR1 = "info_scale = `h1-info`",
    INVAR2 = "info_scale = `h0-h1-info`",
    SS0 = "info_scale = `h0-info`",
    SS1 = "info_scale = `h1-info`",
    SS2 = "info_scale = `h0-h1-info`"
  )
```
