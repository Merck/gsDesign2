...
The IA is planned 20 months after opening enrollment, followed by the FA at month 36. 
...
We use the null hypothesis information for boundary crossing probability calculations under both the null and alternate hypotheses.
This will also imply the null hypothesis information will be used for the information fraction used in spending functions to derive the design.
...
In the original designs, we employ the Lan-DeMets spending function used to approximate O'Brien-Fleming
bounds [@lan1983discrete] for both efficacy and futility bounds.
