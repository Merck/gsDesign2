...
We will assume a wide range of potential underlying hazard ratios for IA2 and FA.  Given the future assumed HR at IA2 and FA from 0.6 to 1.1, we translate the HR to standardized effect size as shown below.
```{r}
