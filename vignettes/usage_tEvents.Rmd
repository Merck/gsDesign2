...
x <- tEvents(enroll_rate = enroll_rate, fail_rate = fail_rate,
...
x <- AHR(enroll_rate = enroll_rate, fail_rate = fail_rate, 
         ratio = ratio, total_duration = 20)
cat("The number of events by 20 months is ", x$Events, ".\n")

y <- tEvents(enroll_rate = enroll_rate, fail_rate = fail_rate,
...
The inner logic of `tEvents()` is to uniroot `AHR()` on `total_duration`.
