...
We now provide a small update to the algorithm of Chapter 19 of @JTBook to do the numerical integration required to compute the boundary crossing probabilities of the previous section and also identifying group sequential boundaries satisfying desired characteristics.
...
# Null hypothesis
grid1_0 <- gsDesign2:::h1(theta = 0, I = info[1], a = a1, b = b1)
grid1_0 %>% head()
```
...
```{r}
grid1_1 <- gsDesign2:::h1(theta = theta[1], I = info[1], a = a1, b = b1)
...
grid2_0 <- gsDesign2:::hupdate(theta = 0, I = info[2], a = b2_0, b = Inf, Im1 = info[1], gm1 = grid1_0)
