...
tibble(
  ...
  Z_upper = c(
    (x1$bounds %>% filter(Bound == "Upper"))$Z,
    (x2 %>% filter(Bound == "Upper"))$Z
  ),
  Z_lower = c(
    (x1$bounds %>% filter(Bound == "Lower"))$Z,
    NA,
    NA,
    (x2 %>% filter(Bound == "Lower"))$Z
  ),
  prob_upper = c(
    (x1$bounds %>% filter(Bound == "Upper"))$Probability,
    (x2 %>% filter(Bound == "Upper"))$Probability
  ),
  prob_lower = c(
    (x1$bounds %>% filter(Bound == "Lower"))$Probability,
    NA,
    NA,
