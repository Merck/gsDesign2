...
#> $prob_alpha
#> [1] 1.264453e-09 1.010150e-03 1.241675e-02
#> 
#> $prob_alpha_plus
#> [1] 1.264453e-09 1.432083e-03 1.187477e-01
#> 
#> $prob_beta
#> [1] 0.97176658 0.02722326 0.00411690
#> 
...
gs_cp(x = x, 
  ...
  zi = -gsDesign::hrn2z(hr = 0.8, n = 150+180, ratio = 1))
#> $prob_alpha
#> [1] 8.260564e-09 8.860056e-03 3.791433e-02
#> 
#> $prob_alpha_plus
#> [1] 8.260564e-09 1.477123e-02 5.010216e-01
#> 
#> $prob_beta
#> [1] 0.944398183 0.046741752 0.001633894
#> 
...
gs_cp(x = x, i = 1,
      zi = -gsDesign::hrn2z(hr = 0.8, n = 150+180, ratio = 1))
#> $prob_alpha
#> [1] 1.282562e-09 1.144666e-03 1.033368e-01
#> 
#> $prob_alpha_plus
#> [1] 1.282562e-09 1.144666e-03 1.032815e-01
#> 
#> $prob_beta
...
gs_cp(x = x,
  ...
  zi = -gsDesign::hrn2z(hr = 0.8, n = 150+180, ratio = 1))
#> $prob_alpha
#> [1] 7.790501e-09 1.168612e-02 4.563741e-01
#> 
#> $prob_alpha_plus
#> [1] 7.790501e-09 1.168612e-02 4.560923e-01
#> 
#> $prob_beta
